...
DAY = "2026-09-05"
TARGETS = [
    ("Olimpija Ljubljana","Grosuplje"),("Motor Lublin","Legia"),("Dynamo Dresden","Bochum"),
    ("Dunajska Streda","Slovan Bratislava"),("Longford","Kerry"),("Marsaxlokk","Mosta FC"),
    ("Grasshoppers","Zurich"),("Standard Liege","Antwerp"),("St Truiden","RAAL La Louviere"),
    ("Le Havre","Brest"),("Nice","Le Mans"),("Roma","Atalanta"),
    ("Bragantino","Bahia"),("Goias","Fortaleza"),("Novorizontino","Avai"),
    ("Santa Cruz","Union Espanola"),("Rijeka","Osijek"),("St Mirren","Celtic"),
    ("Villarreal","Deportivo La Coruna"),("Eldense","Mallorca"),("Swansea","Wrexham"),
    ("Santiago City","Concon Nacional"),("Sporting CP","Nacional"),("Monagas B","Aragua"),
    ("Deportes Linares","Colchagua"),("FC Moravia","Santa Ana"),("Sport Huancayo","Sport Boys"),
    ("Juventude","Atletico GO"),("Boyaca Chico","Once Caldas"),("Maldonado","Wanderers"),
    ("Sao Paulo","Atletico MG"),("Ceara","Sport Recife"),("Everton","Universidad Catolica"),
    ("San Luis","Cobreloa"),("San Lorenzo","2 de Mayo"),("Miramar","Colon"),
    ("Portuguesa","Zamora"),("Herediano","Perez Zeledon"),("Independiente del Valle","Macara"),
    ("Detroit","Hartford Athletic"),("Indy Eleven","Birmingham"),("Miami FC","Pittsburgh"),
    ("Sporting Jax","Lexington"),("Chattanooga Red Wolves","Greenville"),("Atletico San Luis","Guadalajara"),
    ("Cusco","Moquegua"),("Cucuta","Deportivo Pasto"),("Independiente Santa Fe","Fortaleza"),
    ("Rhode Island","Louisville City"),("Tampa Bay","Brooklyn"),("FC Naples","Boise"),
    ("Fort Wayne","New York Cosmos"),("Sarasota Paradise","Spokane Velocity"),("Fluminense","Vasco"),
    ("Universidad de Chile","Coquimbo"),("Arica","Copiapo"),("Union Omaha","Charlotte Independence"),
    ("San Antonio","FC Tulsa"),("Corpus Christi FC","Forward Madison"),("Orange County SC","Sacramento Republic"),
    ("Tigres UANL","Necaxa"),("Atletico Morelia","Alebrijes Oaxaca"),("Cancun","Cruz Azul Hidalgo"),
    ("Jaiba Brava","Venados"),("Piratas","Correcaminos UAT"),("Junior","Jaguares de Cordoba"),
    ("Universitario","Comerciantes Unidos"),("Alajuelense","Saprissa"),("Guadalupe","CS Uruguay"),
    ("Monterey Bay","Phoenix Rising"),("Las Vegas Lights","New Mexico"),("AV Alta","One Knoxville"),
    ("Atlas","Atlante"),
]
...
class Command(BaseCommand):
    help = "Score missing late Sep 5 screenshot predictions and rank BTTS candidates with odds excluded."
