...
class Command(BaseCommand):
    ...
    def _ids_from_active_enrichment(self, target_date, limit):
        """Reuse the exact shortlist already persisted by ENRICH_CANDIDATES.

        This removes the second high_recall_candidate_pool query that previously
        made RESCORE_V8 appear frozen. It does not alter candidate/selection rules.
        """
